...
class SegmentationStreamSpec: QuickSpec { // TODO: The SegmentationStreamSpec is copy of SegmentationSpec. Try to reuse common code to test all configuration at one place if possible.

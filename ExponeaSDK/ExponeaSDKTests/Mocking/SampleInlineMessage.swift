...
extension PersonalizedInlineMessageResponse {
    static func getSample(status: InlineMessageStatus, ttlSeen: Date) -> Self {
        .init(
            id: "649053bd2a632dc7d38c4ac2",
            status: status,
            ttlSeconds: 5,
